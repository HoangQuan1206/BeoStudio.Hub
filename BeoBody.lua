...
local Title = "BeoStudio Hub [Premium]" .. (getgenv().Premium and " [Premium]" or "")
local SubTitle = "Version 0.1"
...
local UiIntilize = {
    ["Main Farm"] = {
        ...
        {Mode="Toggle",Title="Mastery Fruit or Gun", Description = "Default Is Fruit, Turning On = Using Gun, Must Enable Mastery Farm",Args = {"Mastery","Fruit or Gun"}},
        {
            Mode = "Toggle",
    ...
    ["Player-Status"] = {
        {Mode="Label",Title="Tạm Dừng Hoạt Động"}
    },
    ["Fruit"] = {
        {
            Mode = "Toggle",
...
=
    ...
    ["Game-Server"] = {
        ...
        {
            Mode = "Toggle",
            Title = "Remove Effect (For Essentials Only)",
