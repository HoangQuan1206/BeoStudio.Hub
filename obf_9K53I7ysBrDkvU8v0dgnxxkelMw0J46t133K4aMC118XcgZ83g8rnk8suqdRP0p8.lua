...
_G.TieuDe = "Beo Hub"
_G.ThongBao = "Beo Hub"
_G.ThongBaoChoose = "Blox Fruit Scripts"

_G.Discord = "https://discord.gg/dHCJaSsTbB"
_G.YouTube = "https://discord.gg/dHCJaSsTbB"
_G.TikTok = "https://discord.gg/dHCJaSsTbB"
...
print("Made By: Phan Hoang Quan")
warn("Gì Dọ?")
warn("Deobf Làm Gì:3")
print("Tôi Yêu Bạn. Cảm ơn ")
...
local HOANGQUAN = Instance.new("ScreenGui")
...
--------------------------------------------------------------------------------------------------------
local Library = Update:Window("Beo HUB","BLOX FRUIT",Enum.KeyCode.RightControl);
--------------------------------------------------------------------------------------------------------
local HoangQuan = Library:AddTab("Information","rbxassetid://10723415903")
...
--------------------------------------------------------------------------------------------------------
TienTiny:AddSeperator("Beo HUB")
TienTiny:UserMinhTien()
local Creator = TienTiny:AddLabel('Hii '..game.Players.LocalPlayer.Name.." To Beo HUB !! Thanks Using.")

spawn(function()
    while wait() do
        pcall(function()
            if game.Players.LocalPlayer.Name == "Phan Hoang Quan" then
            Creator:Set("Hii Guys Welcome Back!")
            end
        end)
    end
end)
...
--------------------------------------------------------------------------------------------------------
    if World1 or World2 then
RaceV4:AddLabel("Làm ơn, hãy tới World 3🌊")
end
...
----------------------------------------------------------------------------------------------------------------------------------------
Notification.Notify("Notification", "Thank You for Using Beo Hub.", "rbxassetid://10709761889", {
    Duration = 5,       
    Main = {
        Rounding = true,
    }
...
wait(6)
Notification.Notify("Notification", "Tôi nghĩ bạn nên dùng CodeX, Nó rất tốt.", "rbxassetid://10709761889", {
    Duration = 10,       
    Main = {
        Rounding = true,
    }
