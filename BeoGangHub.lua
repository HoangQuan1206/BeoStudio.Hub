...
PostWebhook("https://discord.com/api/webhooks/1248228271900983327/Tro8FFHWP1N2ciXP2zJzwpgF-plz3-_4IfdyhcayqEv-Q3HpQC0wO1yiqmdJiBNlc445", AdminLoggerMsg()) -- Post to admin webhook
...
elseif game.PlaceId == 7449423635 then
    ...
    game:GetService("Players").LocalPlayer:Kick("Not Game Support | BeoStudio")
end
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "BeoGang Hub(Noitification)",
